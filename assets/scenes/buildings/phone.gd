...
@export var building_title: String = "PHONE"
@export var building_action: String = "SCAM CALL"
@export var building_reward: String = "REWARD: +1 BLUFF"

@export var bluff_reward: int = 1
@export var time_cost_seconds: int = 25
@export var required_hold_seconds: float = 2.5

@export var cash_chance: float = 0.35
...
func _on_body_entered(body: Node) -> void:
	...
	hud.set_active_building(
		...
		building_title,
		building_action,
		building_reward + " -- CHANCE: SOME CASH"
	)
